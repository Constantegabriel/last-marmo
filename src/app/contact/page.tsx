  ...
  return (
    <section className="bg-gray-100 min-h-screen py-16 px-8 md:px-20">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl mt-[130px] md:text-5xl font-bold text-gray-800">
          Contato
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="flex flex-col gap-3">
            <Link
              href="https://api.whatsapp.com/send?phone=48998143419"
              target="_blank"
            >
              <button className="flex items-center px-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-full transition gap-2">
                <FaWhatsapp size={20} /> Fale pelo WhatsApp
              </button>
            </Link>
            <Link
              href="https://www.instagram.com/marmorariaflorianopolis?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
              target="_blank"
            >
            ...
            <Link
              href="https://www.facebook.com/marmorariafpolis/"
              target="_blank"
            >
              <button className="flex items-center px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-full transition gap-2">
                <FaFacebook size={20} /> Siga-nos no Facebook
              </button>
            </Link>
          </div>
        </div>
